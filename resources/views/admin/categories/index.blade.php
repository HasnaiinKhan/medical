...
=======
                                    <p class="text-xs text-slate-500 truncate">
                                        slug: <code class="bg-slate-100 px-1 rounded text-slate-600">{{ $cat->slug }}</code>
                                        &nbsp;·&nbsp;
                                        <span class="{{ $cat->medicines_count > 0 ? 'text-blue-700 font-semibold' : 'text-slate-400' }}">
                                            {{ $cat->medicines_count }} {{ $cat->medicines_count === 1 ? 'medicine' : 'medicines' }}
>>>>>>> 790fbb57cd8a67fb90eb8f1a6093c048cf5a90eb
                                        </span>
                                    </p>
                                </div>
...
=======
                        <div class="flex flex-wrap items-center gap-2 flex-shrink-0">
                                <a href="{{ route('admin.medicines.index', ['category' => $cat->slug]) }}"
                                   class="rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 hover:bg-slate-50 hover:border-blue-300 hover:text-blue-800 transition-colors whitespace-nowrap">
>>>>>>> 790fbb57cd8a67fb90eb8f1a6093c048cf5a90eb
                                    View Medicines
                                </a>
...
=======
                                                class="rounded-lg bg-red-50 px-3 py-1.5 text-xs font-semibold text-red-600 hover:bg-red-100 transition-colors whitespace-nowrap">
>>>>>>> 790fbb57cd8a67fb90eb8f1a6093c048cf5a90eb
                                            Delete
                                        </button>
                                    </form>
...
=======
                                    <span class="rounded-lg bg-slate-100 px-3 py-1.5 text-xs font-medium text-slate-400 cursor-not-allowed whitespace-nowrap"
>>>>>>> 790fbb57cd8a67fb90eb8f1a6093c048cf5a90eb
